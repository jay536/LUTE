...
namespace Mapbox.Unity.Location
{
    ...
    public class LocationProviderFactory : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("Provider for updating the player's position on the map")]
        ImmediatePositionWithLocationProvider _playerMapMovement;
        ...
        public ImmediatePositionWithLocationProvider PlayerMapMovement
        {
            get
            {
                return _playerMapMovement;
            }
        }
