...
namespace LoGaCulture.LUTE
{
    ...
    [RequireComponent(typeof(BogAchievementsManager))]
#endif
    public class LogaManager : MonoBehaviour
    {
        ...
        public BogAchievementsManager BogAchievementsManager { get; private set; }
#endif
        ...
        private void Awake()
        {
            ...
            BogAchievementsManager = GetComponent<BogAchievementsManager>();
#endif
        }
