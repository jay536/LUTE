...
{
    [CustomEditor(typeof(LockInventoryItem))]
    public class LockInventoryItemEditor : OrderEditor
    {
        ...
        public override void DrawOrderGUI()
        {
            ...
            itemIndex = EditorGUILayout.Popup("Item to Lock", itemIndex, scriptableItems.Select(x => x.name).ToArray());
