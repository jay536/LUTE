...
{
    [CustomEditor(typeof(UnlockInventoryItem))]
    public class UnlockInventoryItemEditor : OrderEditor
    {
        ...
        public override void DrawOrderGUI()
        {
            ...
            itemIndex = EditorGUILayout.Popup("Item to Unlock", itemIndex, scriptableItems.Select(x => x.name).ToArray());
