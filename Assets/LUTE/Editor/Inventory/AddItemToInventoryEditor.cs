...
{
    [CustomEditor(typeof(AddItemToInventory))]
    public class AddItemToInventoryEditor : OrderEditor
    {
        ...
        public override void DrawOrderGUI()
        {
            ...
            itemIndex = EditorGUILayout.Popup("Item to Add", itemIndex, scriptableItems.Select(x => x.name).ToArray());
